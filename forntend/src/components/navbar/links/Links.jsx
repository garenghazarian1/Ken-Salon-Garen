      ...
      <div className={styles.container}>
        ...
        {session ? (
          ...
          <div className={styles.imageContainer} >       
            <Image src={session?.user?.image } alt="Profile" as="image" width={50} height={50} priority className={styles.image}   />
        ...
        {open && (
          <div ref={menuRef} className={styles.menuContainer}>
             {session ? (
              ...
              <Image src={session?.user?.image } alt="Profile"   width={50} height={50} priority className={styles.image} />
              </Link>
              <button onClick={handleLogout} className={styles.button}>Logout</button>

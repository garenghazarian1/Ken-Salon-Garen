...
const HamburgerButton = ({ isOpen, toggle }) => {
    ...
    return (
      <button
        onClick={toggle}
        className="hamburger-btn lg:hidden fixed top-4 right-8 z-50 flex flex-col justify-center items-center w-12 h-12 rounded-md bg-transparent hover:bg-teal-900 "

        ...
        <div key={store._id} className={styles.flex}>
          ...
          <div className={styles.section}>
            ...
            <div style={{ marginTop: '32px' }}>
              ...
              <p className={styles.p}>Phone: <a className={styles.a} href={`tel:${store.phone}`}>{store.phone}</a></p>
              <p className={styles.p}>Mobile: <a className={styles.a} href={`tel:${store.mobile}`}>{store.mobile}</a></p>
              <p className={styles.p}>Barber Mobile:: <a className={styles.a} href={`tel:${store.mobileOne}`}>{store.mobileOne}</a></p>
